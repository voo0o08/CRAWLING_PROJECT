...
for page_num in range(1, max_page_num+1):
    ...
    url = f"https://work.go.kr/wnSearch/unifSrch.do?regDateStdt=&regDateEndt=&colName=tb_workinfo&srchDateSelected=all&sortField=RANK&sortOrderBy=DESC&searchDateInfo=&temp=&pageIndex={page_num}&tabName=tb_workinfo&dtlSearch=&query=AI&radio_period=on&srchStdt=&srchEndt=&reQuery=&agreeQuery=&prikeyQuery=&exceptQuery="
...
df.to_csv('iframe_AI.csv', sep=',', na_rep='NaN', encoding='utf-8')